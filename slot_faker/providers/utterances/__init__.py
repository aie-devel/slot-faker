...
class Provider(BaseProvider):
    ...
    wiki_typos = {
        ...
        'Puccini': 'Pucini',
        'Puerto': 'Puertorricans',
        'Rican': 'Puertorrican',
        'Ricans': 'Puertorricans',
        'pumpkin': 'pumkin',
    ...
    def random_case(self, utterance: str):
        return utterance.lower() if random.getrandbits(1) else utterance
